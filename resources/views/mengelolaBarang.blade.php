...
<body>
    ...
    <div class="container">
        <div class="MengelolaBarang" style="color: black; font-size: 25px; font-family: Roboto; font-weight: 700; padding-top: 10px;">
            Mengelola Barang</div>
    </div>
    ...
    <table class="table table-bordered mx-auto" style="width: 85%; margin-top: 10px; border-color: gray; border-radius: 10px; overflow: hidden;">
        <thead>
            <tr style="background-color: #3D9EDE; color: white;">
                <th scope="col" style="width: 10%; text-align: center;">Kode Barang</th>
                <th scope="col" style="width: 10%; text-align: center;">Nama Barang</th>
                <th scope="col" style="text-align: center;">Deskripsi Barang</th>
                <th scope="col" style="width: 10%; text-align: center;">Status Barang</th>
                <th scope="col" style="width: 10%; text-align: center;">Merek Barang</th>
        ...
        <tbody>
            ...
            <tr style="height: 80px" class="barang-row">
                <th scope="row" style="text-align: center; vertical-align: middle; font-weight: normal">{{ $barangItem->kode_barang }}</th>
                <th scope="row" style="text-align: center; vertical-align: middle; font-weight: normal">{{ $barangItem->nama_barang }}</th>
                <th scope="row" style="text-align: justify; vertical-align: middle; font-weight: normal">{{ $barangItem->deskripsi_barang }}</th>
                <th scope="row" style="text-align: center; vertical-align: middle; font-weight: normal">{{ $barangItem->status_barang }}</th>
                <th scope="row" style="text-align: center; vertical-align: middle; font-weight: normal">{{ $barangItem->merek_barang }}</th>
                <td style="text-align: center; vertical-align: middle; align-items: center;">
                    <a href="{{ route('ubah-barang', ['idbarang' => $barangItem->idbarang]) }}" class="btn btn-warning" style="margin-right: 35px; font-weight: bold;">Ubah</a>
                    <button type="button" class="btn btn-danger delete-btn" data-id="{{ $barangItem->idbarang }}" style="font-weight: bold;">Hapus</button>
                </td>
            </tr>
            @endforeach
        </tbody>
